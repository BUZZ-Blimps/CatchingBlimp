...
if [ "$1" != "" ]; then
	...
	ssh pi@$hostname 'rm -rf /home/pi/piStereoVision_InProgressSrc'
	
	echo ">>Copying workspace source code files to pi@$hostname"
	scp -r ./piStereoVision_InProgressSrc pi@$hostname:/home/pi/
	
	echo "Killing program."
	ssh pi@$hostname 'sudo killall -9 piStereoVision'
	
	echo "Compiling code."
	ssh pi@$hostname 'make -C /home/pi/piStereoVision_InProgressSrc'
