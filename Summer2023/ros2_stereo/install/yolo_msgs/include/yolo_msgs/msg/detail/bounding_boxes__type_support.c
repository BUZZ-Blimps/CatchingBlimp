...
#include <stddef.h>
#include "yolo_msgs/msg/detail/bounding_boxes__rosidl_typesupport_introspection_c.h"
...
#include "yolo_msgs/msg/bounding_box.h"
// Member `bounding_boxes`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  yolo_msgs__msg__BoundingBoxes__init(message_memory);
}

void BoundingBoxes__rosidl_typesupport_introspection_c__BoundingBoxes_fini_function(void * message_memory)
{
  yolo_msgs__msg__BoundingBoxes__fini(message_memory);
}

size_t BoundingBoxes__rosidl_typesupport_introspection_c__size_function__BoundingBox__bounding_boxes(
  const void * untyped_member)
{
  const yolo_msgs__msg__BoundingBox__Sequence * member =
    (const yolo_msgs__msg__BoundingBox__Sequence *)(untyped_member);
  return member->size;
}
...
{
  yolo_msgs__msg__BoundingBox__Sequence * member =
    (yolo_msgs__msg__BoundingBox__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  yolo_msgs__msg__BoundingBox__Sequence * member =
    (yolo_msgs__msg__BoundingBox__Sequence *)(untyped_member);
  yolo_msgs__msg__BoundingBox__Sequence__fini(member);
  return yolo_msgs__msg__BoundingBox__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember BoundingBoxes__rosidl_typesupport_introspection_c__BoundingBoxes_message_member_array[1] = {
  {
    ...
    offsetof(yolo_msgs__msg__BoundingBoxes, bounding_boxes),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers BoundingBoxes__rosidl_typesupport_introspection_c__BoundingBoxes_message_members = {
  ...
  1,  // number of fields
  sizeof(yolo_msgs__msg__BoundingBoxes),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yolo_msgs, msg, BoundingBoxes)() {
