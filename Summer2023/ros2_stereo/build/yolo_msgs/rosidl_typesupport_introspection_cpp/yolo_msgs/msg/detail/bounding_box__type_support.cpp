...
{
  new (message_memory) yolo_msgs::msg::BoundingBox(_init);
}

void BoundingBox_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolo_msgs::msg::BoundingBox *>(message_memory);
...
{
  return &::yolo_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBox_message_type_support_handle;
}
