...
class BoundingBoxes(metaclass=Metaclass_BoundingBoxes):
    ...
    _fields_and_field_types = {
        'bounding_boxes': 'sequence<yolo_msgs/BoundingBox>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['yolo_msgs', 'msg'], 'BoundingBox')),  # noqa: E501
    )
