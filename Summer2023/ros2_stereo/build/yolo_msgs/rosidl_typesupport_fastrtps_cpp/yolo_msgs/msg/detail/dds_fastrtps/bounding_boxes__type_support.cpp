...
#include "yolo_msgs/msg/detail/bounding_boxes__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        yolo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundingBox(
...
{
  auto typed_message =
    static_cast<const yolo_msgs::msg::BoundingBoxes *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolo_msgs::msg::BoundingBoxes *>(
    untyped_ros_message);
...
{
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_BoundingBoxes__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo_msgs, msg, BoundingBoxes)() {
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_BoundingBoxes__handle;
}
