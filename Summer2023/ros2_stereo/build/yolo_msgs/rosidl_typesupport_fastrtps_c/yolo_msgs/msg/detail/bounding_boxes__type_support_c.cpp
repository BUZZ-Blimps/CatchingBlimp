...
#include "yolo_msgs/msg/detail/bounding_boxes__rosidl_typesupport_fastrtps_c.h"
...
#include "yolo_msgs/msg/detail/bounding_box__functions.h"  // bounding_boxes
...
using _BoundingBoxes__ros_msg_type = yolo_msgs__msg__BoundingBoxes;
  ...
  // Field name: bounding_boxes
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, yolo_msgs, msg, BoundingBox
      )()->data);
...
size_t get_serialized_size_yolo_msgs__msg__BoundingBoxes(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BoundingBoxes__ros_msg_type * ros_message = static_cast<const _BoundingBoxes__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_yolo_msgs__msg__BoundingBox(
...
static uint32_t _BoundingBoxes__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yolo_msgs__msg__BoundingBoxes(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yolo_msgs
size_t max_serialized_size_yolo_msgs__msg__BoundingBoxes(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_yolo_msgs__msg__BoundingBox(
...
{
  return max_serialized_size_yolo_msgs__msg__BoundingBoxes(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolo_msgs, msg, BoundingBoxes)() {
