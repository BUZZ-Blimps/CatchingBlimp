...
struct Node_
{
  ...
  using _entities_type =
    std::vector<micro_ros_msgs::msg::Entity_<ContainerAllocator>, typename ContainerAllocator::template rebind<micro_ros_msgs::msg::Entity_<ContainerAllocator>>::other>;
  ...
  Type & set__entities(
    const std::vector<micro_ros_msgs::msg::Entity_<ContainerAllocator>, typename ContainerAllocator::template rebind<micro_ros_msgs::msg::Entity_<ContainerAllocator>>::other> & _arg)
  {
    this->entities = _arg;
    return *this;
  }
