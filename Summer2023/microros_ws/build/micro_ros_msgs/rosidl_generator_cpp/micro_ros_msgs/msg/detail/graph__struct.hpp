...
struct Graph_
{
  ...
  using _nodes_type =
    std::vector<micro_ros_msgs::msg::Node_<ContainerAllocator>, typename ContainerAllocator::template rebind<micro_ros_msgs::msg::Node_<ContainerAllocator>>::other>;
  _nodes_type nodes;

  // setters for named parameter idiom
  Type & set__nodes(
    const std::vector<micro_ros_msgs::msg::Node_<ContainerAllocator>, typename ContainerAllocator::template rebind<micro_ros_msgs::msg::Node_<ContainerAllocator>>::other> & _arg)
  {
    this->nodes = _arg;
    return *this;
  }
