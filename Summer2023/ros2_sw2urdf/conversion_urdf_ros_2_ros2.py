...
# This variable is the path to the solidworks output folder of urdf files (the file to be converted)
source_dir = '/home/corelab-laptop2/Downloads/burn_cream_blimp' #CHANGE
# This variable is the package path of ros2 (where we want the converted file to be at)
target_dir = '/home/corelab-laptop2/test_urdf_tool_ws/src/test_urdf_tool' #CHANGE
# This variable is the package-name of ros2
package_name = "test_urdf_tool" #CHANGE
# This variable is the solidworks output folder name
output_folder_name = "burn_cream_blimp" #CHANGE
