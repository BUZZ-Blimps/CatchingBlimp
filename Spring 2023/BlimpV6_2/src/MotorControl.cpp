...
MotorControl::MotorControl(int LSPin, int RSPin, int LMPin, int RMPin, double newdeadband, double newturnOnCom, double newminCom, double newmaxCom, double servoFilter) {
    //set servo pins
...
void MotorControl::update(double pitch, double forward, double up, double yaw) {
...
void MotorControl::writeLServo(double angle) {
  this->LServo.write(angle);
}

void MotorControl::writeRServo(double angle) {
